...
<body>
	<div class="card">
		...
		<section class="view" style="height: 530px" id="view">
			<h1 style="color: white; text-align: center">Student Information</h1>
			...
			<div class="text-center w-100">
				...
				<marquee>
					<h1 style="color: silver;">${message }</h1>
				</marquee>
			</div>
						...
						<tr>
							...
							<td>
								...
								<div class="btn-group btn-group-sm" role="group" aria-label="...">
									...
									<a class="btn btn-outline-primary" href="batch?id=${s.studentId}">Shift Batch</a> 
			...
			<nav aria-label="...">
				<ul class="pagination pagination-sm">
					<li class="page-item active"><a class="page-link"
						aria-current="page" href="pagging?pageNo=0">1</a></li> 
